...
print(bisect_left(a, x))  # 4를 삽입할 가장 왼쪽 index 따라서 a[2] >> 2
print(bisect_right(a, x))  # 4를 삽입할 가장 오른쪽 index 따라서 a[4] >> 2
...
# 4를 삽입할 가장 왼쪽 index 6 , 4를 삽입할 가장 오른쪽 index 8
print(count_by_range(a, 4, 4))  # 2
# -1을 삽입할 가장 왼쪽 index 0 , 3을 삽입할 가장 오른쪽 index 6
